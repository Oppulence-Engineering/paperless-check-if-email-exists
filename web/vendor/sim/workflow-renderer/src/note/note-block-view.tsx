 ...
 */
const NOTE_SEARCH_MARK_CLASS = 'rounded-none bg-current/20 text-inherit'
const NOTE_SEARCH_ACTIVE_MARK_CLASS = 'rounded-none bg-orange-400 text-black'
...
const NOTE_COMPONENTS = {
  ...
  img: ({ src, alt, width, height }: ComponentProps<'img'>) => (
    <img
      ...
      width={width}
      height={height}
      className='my-2 block h-auto max-w-full rounded-none'
    />
  ),
    ...
    if (embedInfo) {
      return (
        <span className='my-2 block w-full'>
          ...
          <span className='block w-full overflow-hidden rounded-none'>
    ...
    >
      ...
      >
        ...
        <div
          ...
          className={cn(
            'relative z-20 select-none rounded-none transition-[color,width,height] [transition-duration:150ms,280ms,280ms] [transition-timing-function:cubic-bezier(0.23,1,0.32,1)] motion-reduce:transition-none',
            isExpanded
            ...
            <div className='flex min-w-0 flex-1 items-center transition-opacity duration-150 [transition-timing-function:cubic-bezier(0.23,1,0.32,1)]'>
              {editingField === 'title' ? (
                ...
                <button
                  ...
                  className={cn(
                    'min-w-0 flex-1 cursor-text rounded-none bg-transparent text-left',
                    !isEnabled && 'opacity-50'
                  )}
                >
              ...
              <Tooltip.Root preferAbove>
                <Tooltip.Trigger asChild>
                  <Button
                    ...
                    className='nodrag nopan nowheel pointer-events-none ml-1 size-[24px] shrink-0 rounded-none border-none bg-transparent p-0 text-current opacity-0 transition-[background-color,color,opacity,transform] duration-150 hover-hover:bg-current/10 hover-hover:opacity-100 active:scale-[0.96] group-hover:pointer-events-auto group-hover:opacity-70 group-data-[node-selected]:pointer-events-auto group-data-[node-selected]:opacity-70'
                  >
              ...
              <>
                {isInlineEditable && (
                  <button
                    ...
                    className='absolute inset-0 z-20 w-full cursor-text rounded-none bg-transparent'
                  />
                )}
                <div
