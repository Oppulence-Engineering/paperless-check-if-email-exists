...
export function SubflowStartView({
  ...
  return (
    <div
      className='absolute top-3 left-[16px] flex h-[34px] w-[58px] items-center justify-center rounded-none'
...
export function SubflowNodeView({
  ...
  return (
    ...
    >
      ...
      <div
        className='relative select-none rounded-none'
        style={{
          width,
          height,
          overflow: 'visible',
      ...
      >
        <div
          aria-hidden='true'
          className='pointer-events-none absolute inset-0 z-40 rounded-none opacity-0 ring-[1.5px] ring-[var(--text-secondary)] transition-opacity duration-100 [.subflow-node-drop-target_&]:opacity-100'
