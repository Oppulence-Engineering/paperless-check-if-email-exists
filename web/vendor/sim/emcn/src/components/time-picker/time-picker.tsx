...
const timePickerVariants = cva(
  'flex w-full rounded-none border border-[var(--border-1)] bg-[var(--surface-5)] px-2 font-sans text-[var(--text-primary)] placeholder:text-[var(--text-muted)] outline-hidden disabled:cursor-not-allowed disabled:opacity-50 transition-colors',
  {
    variants: {
      variant: {
        default: '',
      ...
      <Popover open={open} onOpenChange={setOpen}>
        <div ref={ref} className='relative w-full' {...props}>
          ...
          <PopoverContent
            ...
            align='start'
            sideOffset={4}
            className='w-auto rounded-none border border-[var(--border-1)] p-2'
          >
            <div className='flex items-center gap-1.5'>
              <input
                ref={hourInputRef}
                className='w-[40px] rounded-none border border-[var(--border-1)] bg-[var(--surface-5)] px-1.5 py-[5px] text-center font-sans text-[var(--text-primary)] text-small outline-hidden transition-colors placeholder:text-[var(--text-muted)]'
                value={hour}
              ...
              <input
                ...
                autoComplete='off'
              />
              <div className='ml-0.5 flex overflow-hidden rounded-none border border-[var(--border-1)]'>
