...
const STYLES = {
  ...
  itemBase:
    'flex min-w-0 cursor-pointer items-center gap-2 rounded-none px-2 disabled:pointer-events-none disabled:opacity-50 disabled:cursor-not-allowed',

  /** Content container */
  content: 'px-1.5 py-1.5 rounded-none',
