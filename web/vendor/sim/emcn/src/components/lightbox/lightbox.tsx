          ...
          <div className='flex min-h-full w-max min-w-full items-center justify-center'>
            <ModalClose asChild>
              <button
                ...
                className='m-1 block shrink-0 cursor-pointer overflow-hidden rounded-none border border-[var(--border)] bg-[var(--bg)] p-0 shadow-[var(--shadow-overlay)] outline-none'
              >
                {type === 'image' ? (
                  <img
                    src={src}
