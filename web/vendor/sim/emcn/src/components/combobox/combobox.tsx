...
const comboboxVariants = cva(
  'flex w-full rounded-none border border-[var(--border-1)] bg-[var(--surface-5)] px-2 font-sans text-[var(--text-primary)] placeholder:text-[var(--text-muted)] outline-hidden disabled:cursor-not-allowed disabled:opacity-50',
  {
    variants: {
      variant: {
        default: '',
      ...
      const renderFlatOption = (option: ComboboxOption, index: number) => {
        ...
        return (
          <div
            ...
            className={cn(
              'relative flex cursor-pointer select-none items-center gap-2 rounded-none px-1.5 font-sans',
        ...
        <Popover open={open} onOpenChange={changeOpen}>
          <div ref={containerRef} className='relative w-full' {...props}>
            ...
            <PopoverContent
              ...
              sideOffset={4}
              className={cn(
                'rounded-none border border-[var(--border-1)] p-0',
                    ...
                    <div className='space-y-0.5'>
                      {showAllOption && multiSelect && (
                        <div
                          ...
                          className={cn(
                            'relative flex cursor-pointer select-none items-center rounded-none px-1.5 font-sans',
                            size === 'sm' ? 'py-[5px] text-caption' : 'py-1.5 text-sm',
