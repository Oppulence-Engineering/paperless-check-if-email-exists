 ...
 * Route error boundary for List detail. Next.js requires a Client Component here
 * so the reset callback can remount the segment. Owned by `list-detail.lit.ts`.
 */
export default function ListDetailError({
	...
	return (
		...
		>
			...
			<div>
				<h1 className="font-semibold">List detail could not be loaded</h1>
