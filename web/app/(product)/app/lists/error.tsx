 ...
 * Route error boundary for Email lists. Next.js requires a Client Component here
 * so the reset callback can remount the segment. Owned by `lists.lit.ts`.
 */
export default function ListsError({
	...
	return (
		...
		>
			...
			<div>
				<h1 className="font-semibold">Email lists could not be loaded</h1>
