 ...
 * Route error boundary for Pipelines. Next.js requires a Client Component here
 * so the reset callback can remount the segment. Owned by `pipelines.lit.ts`.
 */
export default function PipelinesError({
	...
	return (
		...
		>
			...
			<div>
				<h1 className="font-semibold">Pipelines could not be loaded</h1>
