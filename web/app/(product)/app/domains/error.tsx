 ...
 * Route error boundary for Domains. Next.js requires a Client Component here
 * so the reset callback can remount the segment. Owned by `domains.lit.ts`.
 */
export default function DomainsError({
	...
	return (
		...
		>
			...
			<div>
				<h1 className="font-semibold">Domains could not be loaded</h1>
