...
export function HeroChatLoop({
	...
	return (
		...
		>
			...
			<div
				className={cn(
					"mx-auto w-[calc(100%-48px)] max-w-chat rounded-none border border-[var(--border)] bg-[var(--white)] px-2.5 py-2 dark:bg-[var(--surface-4)]",
					showWelcome
			...
			>
				...
				{attachedFileName && (
					<div className="mb-1 flex w-fit max-w-full items-center gap-1.5 rounded-none border border-[var(--border)] bg-[var(--surface-2)] py-1 pr-1 pl-2 text-[var(--text-body)] text-xs">
