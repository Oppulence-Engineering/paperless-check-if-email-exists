...
const ACTION_BUTTON_BASE_CLASSES =
	"size-[24px] rounded-none border-none bg-transparent p-0 text-[var(--text-icon)] transition-[background-color,color,opacity,transform] duration-150 active:scale-[0.96]";
...
export function StageBlockCard({
	...
	return (
		<div
			className="group relative h-full w-[250px] select-none rounded-none"
			data-workflow-card
			inert={decorative}
		...
		>
			{showActionMenu ? (
				<>
					...
					<div
						className={cn(
							"-top-[28px] pointer-events-auto absolute right-[24px] z-40 flex h-[28px] items-center gap-[2px] overflow-hidden rounded-none px-[0.2rem] py-0.5 opacity-0 transition-opacity duration-[30ms] [transition-timing-function:cubic-bezier(0.23,1,0.32,1)] group-data-[action-menu-ready]:opacity-100 group-data-[action-menu-ready]:duration-100",
