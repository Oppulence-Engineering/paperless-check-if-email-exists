...
function PreviewActionBar({ block, running, workflowRunning, onRunToggle }: PreviewActionBarProps) {
	...
	return (
		<div
			...
			className="-top-[28px] pointer-events-auto absolute right-[24px] z-[40] h-[28px] w-fit rounded-none px-[0.2rem] py-0.5"
		>
...
function CanvasZoomControls() {
	...
	const buttonClassName = "size-[28px] rounded-none p-0";

	return (
		<div className="absolute bottom-3 left-3 z-30 flex h-[36px] items-center gap-0.5 rounded-none border border-[var(--border)] bg-[var(--surface-2)] p-1">
			<Tooltip.Root>
				<Tooltip.Trigger asChild>
					<Button
						type="button"
