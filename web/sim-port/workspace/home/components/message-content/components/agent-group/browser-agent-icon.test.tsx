...
import { AgentGroup } from '@/sim-port/workspace/home/components/message-content/components/agent-group/agent-group'
...
} from '@/sim-port/workspace/home/components/message-content/components/agent-group/browser-agent-icon'
...
vi.mock('@/lib/sim-port/browser-agent/transport', () => ({ isBrowserAgentAvailable: browserAvailable }))
vi.mock('@/sim-port/workspace/home/components/chat-surface-context', () => ({
