...
import { ActivityStatus, type ActivityStatusProps } from '@/components/sim/activity-status'
import {
  ActivityDisclosure,
  type ActivityDisclosureProps,
} from '@/sim-port/workspace/home/components/message-content/components/agent-group/activity-disclosure'
