...
import { getToolActivitySummaryActions } from '@/lib/sim-port/copilot/tools/tool-activity'
...
import { getActivityAttentionKey } from '@/sim-port/workspace/home/components/message-content/components/agent-group/tool-interactions'
