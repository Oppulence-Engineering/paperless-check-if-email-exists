...
import { isBrowserAgentAvailable } from '@/lib/sim-port/browser-agent/transport'
...
import { ActivityStream } from '@/sim-port/workspace/home/components/message-content/components/agent-group/activity-stream'
import {
  collectGroupTools,
  hasAgentGroupItemContent,
} from '@/sim-port/workspace/home/components/message-content/components/agent-group/agent-group-content'
import { BrowserAgentIcon } from '@/sim-port/workspace/home/components/message-content/components/agent-group/browser-agent-icon'
import { renderInlineMarkdown } from '@/sim-port/workspace/home/components/message-content/components/agent-group/inline-markdown'
import { MainAgentActivity } from '@/sim-port/workspace/home/components/message-content/components/agent-group/main-agent-activity'
import {
  getActiveToolActivityTitle,
  getActivityStatusTool,
  getToolActivitySummary,
} from '@/sim-port/workspace/home/components/message-content/components/agent-group/tool-activity-group'
...
import {
  ...
  needsToolInput,
} from '@/sim-port/workspace/home/components/message-content/components/agent-group/tool-interactions'
import {
  getAgentIcon,
  isToolDone,
} from '@/sim-port/workspace/home/components/message-content/utils'
import { type ToolCallData, ToolCallStatus } from '@/sim-port/workspace/home/types'
import { useSmoothText } from '@/hooks/sim/use-smooth-text'
