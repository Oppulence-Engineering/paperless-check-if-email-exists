...
// @ts-ignore
import type { SavedSegmentView } from './saved-segment-view';

/**
 *
 * @export
 * @interface SavedSegmentListResponse
 */
export interface SavedSegmentListResponse {
    /**
     *
     * @type {Array<SavedSegmentView>}
     * @memberof SavedSegmentListResponse
     */
    'segments': Array<SavedSegmentView>;
    /**
     *
     * @type {number}
     * @memberof SavedSegmentListResponse
