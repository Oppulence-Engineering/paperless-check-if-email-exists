 ...
 *
 * @export
 * @interface IngestOutcomesRequest
 */
export interface IngestOutcomesRequest {
    /**
     *
     * @type {Array<IngestOutcome>}
     * @memberof IngestOutcomesRequest
     */
    'outcomes': Array<IngestOutcome>;
}
